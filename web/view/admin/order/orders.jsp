                                        ...
                                        <tbody>
                                            <c:forEach items="${listOrder}" var="ord">
                                                <tr>
                                                    ...
                                                    <td>${ord.cities.cityName}</td>
                                                    <td>${ord.totalPrice}</td>
                                                    <td>${ord.ships.shipId}</td>
                                                    <td>${ord.orderStatus.orderStatusName}</td>
                                                    <td><fmt:formatDate value="${ord.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${ord.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminOrdersController/initUpdate.htm?orderId=${ord.orderId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-zoom-in " title="Detail" href="${contextPath}/ShowyClothes/adminOrdersController/detail.htm?orderId=${ord.orderId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
