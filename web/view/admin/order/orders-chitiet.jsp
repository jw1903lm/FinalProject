                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="orderUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Order ID:</td> 
                                                <td><f:input style="width:300px" path="orderId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>User</td> 
                                                <td><f:input style="width:300px" path="users.userName" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Full Name</td> 
                                                    <td><f:input style="width:300px" path="fullName" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Phone</td> 
                                                    <td><f:input style="width:300px" path="phone" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Email</td> 
                                                    <td><f:input style="width:300px" path="email" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>City</td> 
                                                    <td><f:input style="width:300px" path="cities.cityName" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>User Address</td> 
                                                    <td><f:input style="width:300px" path="userAddress" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Postcode (Zip)</td> 
                                                    <td><f:input style="width:300px" path="postcodeOrZip" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Total Price</td> 
                                                    <td><f:input style="width:300px" path="totalPrice" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Ship</td> 
                                                    <td><f:input style="width:300px" path="ships.shipId" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Order Status</td> 
                                                    <td><f:input style="width:300px" path="orderStatus.orderStatusId" readonly="true"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Disabled</td> 
                                    ...
                                    <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminOrdersController/getAll.htm">Turn back</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
