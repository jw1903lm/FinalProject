                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Product Images Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listProductImage}" var="proImage">
                                                <tr>
                                                    <td>${proImage.imageId}</td>
                                                    <td><img style="width: 200px;height: auto" src="<%=request.getContextPath()%>/view/img/${proImage.link}" alt=""></td>
                                                    <td>${proImage.products.productId}</td>
                                                    <td><fmt:formatDate value="${proImage.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${proImage.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminProductImagesController/initUpdate.htm?imageId=${proImage.imageId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminProductImagesController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
