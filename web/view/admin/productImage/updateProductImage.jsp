                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="productImageUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Image ID</td> 
                                                <td><f:input path="imageId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Link</td> 
                                                <td><f:input type="file" path="link"/></td>
                                            </tr>
                                            <td>Product</td>
                                            <td>
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminProductImagesController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
