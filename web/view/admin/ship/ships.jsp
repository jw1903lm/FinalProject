                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ships Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listShip}" var="ship">
                                                <tr>
                                                    <td>${ship.shipId}</td>
                                                    <td>${ship.minDistance}</td>
                                                    <td>${ship.maxDistance}</td>
                                                    <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value="${ship.fee}" /></td>
                                                    <td><fmt:formatDate value="${ship.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${ship.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminShipsController/initUpdate.htm?shipId=${ship.shipId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Delete" href="${contextPath}/ShowyClothes/adminShipsController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
