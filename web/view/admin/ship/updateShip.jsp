                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Ship</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="shipUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Ship ID</td> 
                                                <td><f:input path="shipId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Min Distance</td> 
                                                <td><f:input path="minDistance"/></td>
                                            </tr>
                                            <tr>
                                                <td>Max Distance</td> 
                                                <td><f:input path="maxDistance"/></td>
                                            </tr>
                                            <tr>
                                                <td>Free</td> 
                                                <td><f:input path="fee"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminShipsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
