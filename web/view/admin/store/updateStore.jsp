                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="stoUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Store ID</td> 
                                                <td><f:input path="storeId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Store Name</td> 
                                                <td><f:input path="storeName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td> 
                                            ...
                                            <tr>
                                                <td>Store Address</td> 
                                                <td><f:input path="storeAddress"/></td>
                                            </tr>
                                            <tr>
                                                <td>Store Image</td> 
                                                <td><f:input type="file" path="storeImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminStoresController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
