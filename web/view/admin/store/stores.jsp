                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Store Name" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listStore}" var="store">
                                                <tr>
                                                    ...
                                                    <td><img style="width: 200px;height: auto" src="<%=request.getContextPath()%>/view/img/${store.storeImage}" alt=""></td>
                                                    <td><fmt:formatDate value="${store.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${store.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminStoresController/initUpdate.htm?storeId=${store.storeId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminStoresController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
