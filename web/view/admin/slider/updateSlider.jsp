                                ...
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="sliderUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Title</td> 
                                                <td><f:input style="width:350px" path="title"/></td>
                                            </tr>
                                            <tr>
                                                <td>Sub Title</td> 
                                                <td><f:input style="width:350px" path="subTitle"/></td>
                                            </tr>
                                            <tr>
                                                <td>Content</td> 
                                                <td><f:textarea style="width:350px" path="content"/></td>
                                            </tr>
                                            <tr>
                                                <td>Image Link</td> 
                                                <td><f:input style="width:350px" type="file" path="imageLink"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td>
                                                <td>
                                                    <f:select style="width:350px" path="products.productId">
                                                        <f:options items="${listProduct}" itemLabel="productName" itemValue="productId"/> 
                                                    </f:select>
                                                </td>
                                            </tr>
                                            <tr>
