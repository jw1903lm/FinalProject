                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="sliderUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Slider ID</td> 
                                                <td><f:input style="width:350px" path="sliderId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Title</td> 
                                                <td><f:input style="width:350px" path="title" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Sub Title</td> 
                                                <td><f:input style="width:350px" path="subTitle" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Content</td> 
                                                <td><f:textarea style="width:350px" path="content" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Image Link</td> 
                                                <td><img style="width: 500px;height: auto" src="<%=request.getContextPath()%>/view/img/${sliderUpdate.imageLink}" alt=""></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td>
                                                <td><f:input style="width:350px" path="products.productName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminSlidersController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
