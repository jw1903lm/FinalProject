                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="insert.htm" commandName="sliderInsert" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Sub Title</td> 
                                                <td><f:input path="subTitle"/></td>
                                            </tr>
                                            <tr>
                                                <td>Content</td> 
                                                <td><f:textarea path="content"/></td>
                                            </tr>
                                            <tr>
                                                <td>Image Link</td> 
                                                <td><f:input type="file" path="imageLink"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td>
                                                <td>
