            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Title" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 20px">Disabled</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listSlider}" var="slider">
                                                <tr>
                                                    ...
                                                    <td><img style="width: 200px;height: auto" src="<%=request.getContextPath()%>/view/img/${slider.imageLink}" alt=""></td>
                                                    <td>${slider.products.productId}</td>
                                                    <td><fmt:formatDate value="${slider.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${slider.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminSlidersController/initUpdate.htm?sliderId=${slider.sliderId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-remove" title="Add new" href="${contextPath}/ShowyClothes/adminSlidersController/initInsert.htm"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-zoom-in " title="Add new" href="${contextPath}/ShowyClothes/adminSlidersController/detail.htm?sliderId=${slider.sliderId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
