                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Product Comment</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="productCommentUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Comment ID</td> 
                                                <td><f:input path="commentId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>User</td>
                                                <td><f:input path="users.userId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Full Name</td> 
                                            ...
                                            <tr>
                                                <td>Review</td> 
                                                <td><f:textarea path="review" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Rating</td> 
                                                <td><f:input path="rating" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td>
                                                <td><f:input path="products.productId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminProductCommentsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
