                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Add new product comment</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="insert.htm" commandName="productCommentInsert">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Review</td> 
                                                <td><f:textarea path="review"/></td>
                                            </tr>
                                            <tr>
                                                <td>Rating</td> 
                                                <td><f:input path="rating"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td>
                                                <td>
