        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Product Comments Administration
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Product Comments Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listProductComment}" var="proComment">
                                                <tr>
                                                    <td>${proComment.commentId}</td>
                                                    <td>${proComment.users.userName}</td>
                                                    <td>${proComment.fullName}</td>
                                                    <td>${proComment.review}</td>
                                                    <td>${proComment.rating}</td>
                                                    <td>${proComment.products.productName}</td>
                                                    <td><fmt:formatDate value="${proComment.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${proComment.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminProductCommentsController/initUpdate.htm?commentId=${proComment.commentId}"/></td
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
