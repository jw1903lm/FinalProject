    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="${contextPath}/ShowyClothes/adminIndexController/index.htm">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="braUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td>Brand Id:</td> 
                                                <td><f:input path="brandId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Brand Name:</td> 
                                            ...
                                            <tr>
                                                <td>Logo:</td> 
                                                <td><f:input type="file" path="logo"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                                <td>
                                                    True <f:radiobutton value="true" path="isDisabled"/>
                                                    False <f:radiobutton value="false" path="isDisabled"/>   
                                                </td>
                                            </tr>            
                                        </table>  
                                        <input type="submit" value="Update"/>  
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminBrandsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
