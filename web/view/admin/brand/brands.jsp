                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Brand Name" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listBrand}" var="bra">
                                                <tr>
                                                    <td>${bra.brandId}</td>
                                                    <td>${bra.brandName}</td>
                                                    <td><img style="width: 200px;height: auto" src="<%=request.getContextPath()%>/view/img/${bra.logo}" alt=""></td>
                                                    <td><fmt:formatDate value="${bra.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${bra.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminBrandsController/initUpdate.htm?brandId=${bra.brandId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminBrandsController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
