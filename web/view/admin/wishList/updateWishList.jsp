                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Wish List</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="wishListUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td>Product</td> 
                                                <td><select name="product" disabled="true">
                                            ...
                                            <tr>
                                                <td>User</td> 
                                                <td><select name="user"  disabled="true">
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminWishListsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
