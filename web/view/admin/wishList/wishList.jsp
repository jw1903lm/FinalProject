                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Wish Lists Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listWishList}" var="wishList">
                                                <tr>
                                                    <td>${wishList.users.userName}</td>
                                                    <td>${wishList.products.productName}</td>
                                                    <td><fmt:formatDate value="${wishList.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${wishList.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminWishListsController/initUpdate.htm?productId=${wishList.products.productId}&userId=${wishList.users.userId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
