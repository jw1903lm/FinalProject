                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">User Feedbacks Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listUserFeedback}" var="ufb">
                                                <tr>
                                                    <td>${ufb.feedbackId}</td>
                                                    <td>${ufb.users.userId}</td>
                                                    <td>${ufb.fullName}</td>
                                                    <td>${ufb.email}</td>
                                                    <td>${ufb.contactTitle}</td>
                                                    <td>${ufb.contactMessage}</td>
                                                    <td><fmt:formatDate value="${ufb.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${ufb.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminUserFeedbacksController/initUpdate.htm?feedbackId=${ufb.feedbackId}"/>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
