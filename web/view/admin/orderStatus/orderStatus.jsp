                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Order Status Data Table</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listOrderStatus}" var="ord">
                                                <tr>
                                                    <td>${ord.orderStatusId}</td>
                                                    <td>${ord.orderStatusName}</td>
                                                    <td><fmt:formatDate value="${ord.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${ord.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminOrderStatusController/initUpdate.htm?orderStatusId=${ord.orderStatusId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminOrderStatusController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
