                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="salUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Sale ID</td> 
                                                <td><f:input path="saleId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Sale Name</td> 
                                                <td><f:input path="saleName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Percentage</td> 
                                                <td><f:input path="percentage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminSalesController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
