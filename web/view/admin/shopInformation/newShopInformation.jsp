                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Add new shop infomation</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="insert.htm" commandName="shiInsert" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td>Logo Top</td> 
                                                <td><f:input type="file" path="logoTop"/></td>
                                            </tr>
                                            <tr>
                                                <td>Logo Bottom</td> 
                                                <td><f:input type="file" path="logoBottom"/></td>
                                            </tr>
                                            <tr>
                                                <td>Slogan</td> 
                                                <td><f:input path="slogan"/></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Image</td> 
                                                <td><f:input type="file" path="shopImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Description</td> 
                                                <td><f:textarea path="shopDescription"/></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Image</td> 
                                                <td><f:input type="file" path="founderImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Quote</td> 
                                                <td><f:textarea path="founderQuote"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Email</td> 
                                            ...
                                            <tr>
                                                ...
                                                <td><f:input path="contactAddress"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
