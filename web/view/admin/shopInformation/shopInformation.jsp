                                        ...
                                        <tbody>
                                            <c:forEach items="${listShopInformation}" var="shi">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminShopInformationsController/initUpdate.htm?shopInformationId=${shi.shopInformationId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminShopInformationsController/initInsert.htm"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-zoom-in " title="Detail" href="${contextPath}/ShowyClothes/adminShopInformationsController/detail.htm?shopInformationId=${shi.shopInformationId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
