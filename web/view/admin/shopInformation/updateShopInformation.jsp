                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Shop Information</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="shiUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Logo Top</td> 
                                                <td><f:input style="width:350px" type="file" path="logoTop"/></td>
                                            </tr>
                                            <tr>
                                                <td>Logo Bottom</td> 
                                                <td><f:input style="width:350px" type="file" path="logoBottom"/></td>
                                            </tr>
                                            <tr>
                                                <td>Slogan</td> 
                                                <td><f:input style="width:350px" path="slogan"/></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Image</td> 
                                                <td><f:input style="width:350px" type="file" path="shopImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Description</td> 
                                                <td><f:textarea style="width:350px" path="shopDescription"/></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Image</td> 
                                                <td><f:input style="width:350px" type="file" path="founderImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Quote</td> 
                                                <td><f:textarea style="width:350px" path="founderQuote"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Email</td> 
                                                <td><f:input style="width:350px" path="contactEmail"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Phone</td> 
                                                <td><f:input style="width:350px" path="contactPhone"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Address</td> 
                                                <td><f:input style="width:350px" path="contactAddress"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
