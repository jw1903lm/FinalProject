        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Shop Information Administration
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Shop Information View</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form commandName="shiUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Shop Information ID</td> 
                                                <td><f:input style="width:350px" path="shopInformationId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Logo Top</td> 
                                                <td><img style="width: 100px;height: auto" src="<%=request.getContextPath()%>/view/img/${shiUpdate.logoTop}" alt=""></td>
                                            </tr>
                                            <tr>
                                                <td>Logo Bottom</td> 
                                                <td><img style="width: 100px;height: auto" src="<%=request.getContextPath()%>/view/img/${shiUpdate.logoBottom}" alt=""></td>
                                            </tr>
                                            <tr>
                                                <td>Slogan</td> 
                                                <td><f:input style="width:350px" path="slogan" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Image</td> 
                                                <td><img style="width: 200px;height: auto" src="<%=request.getContextPath()%>/view/img/${shiUpdate.shopImage}" alt=""></td>
                                            </tr>
                                            <tr>
                                                <td>Shop Description</td> 
                                                <td><f:textarea style="width:350px" path="shopDescription" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Image</td> 
                                                <td><img style="width: 100px;height: auto" src="<%=request.getContextPath()%>/view/img/${shiUpdate.founderImage}" alt=""></td>
                                            </tr>
                                            <tr>
                                                <td>Founder Quote</td> 
                                                <td><f:textarea style="width:350px" path="founderQuote" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Email</td> 
                                                <td><f:input style="width:350px" path="contactEmail" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Phone</td> 
                                                <td><f:input style="width:350px" path="contactPhone" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Contact Address</td> 
                                                <td><f:input style="width:350px" path="contactAddress" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                                <td >True <f:radiobutton value="true" path="isDisabled" disabled="true"/>
                                                    False <f:radiobutton value="false" path="isDisabled" disabled="true"/></td>
                                            </tr>              
                                        </table>  
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminShopInformationsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
