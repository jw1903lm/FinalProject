                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Admin Name" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listAdmin}" var="adm">
                                                <tr>
                                                    <td>${adm.adminId}</td>
                                                    <td>${adm.adminName}</td>
                                                    <td>${adm.adminPassword}</td>
                                                    <td>${adm.salt}</td>
                                                    <td><fmt:formatDate value="${adm.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${adm.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" href="${contextPath}/ShowyClothes/adminAdminsController/initUpdate.htm?adminId=${adm.adminId}" title="Update"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" href="${contextPath}/ShowyClothes/adminAdminsController/initInsert.htm" title="Add new"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
