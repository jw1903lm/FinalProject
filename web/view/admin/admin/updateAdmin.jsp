                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="admUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Admin ID:</td> 
                                                <td><f:input path="adminId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Admin Name:</td> 
                                                <td><f:input path="adminName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Admin Password</td> 
                                                <td><f:password path="adminPassword"/></td>
                                            </tr>
                                            <tr>
                                                <td>Salt</td> 
                                                <td><f:input path="salt" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                                <td>
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminAdminsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
