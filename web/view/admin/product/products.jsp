                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Product Name" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listProduct}" var="pro">
                                                <tr>
                                                    ...
                                                    <td>${pro.brands.brandName}</td>
                                                    <td>${pro.sales.saleName}</td>
                                                    <td><fmt:formatDate value="${pro.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${pro.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminProductsController/initUpdate.htm?productId=${pro.productId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminProductsController/initInsert.htm"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-zoom-in " title="Detail" href="${contextPath}/ShowyClothes/adminProductsController/detail.htm?productId=${pro.productId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
