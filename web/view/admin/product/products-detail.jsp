                                        ...
                                        <tbody>
                                            <c:forEach items="${listProduct}" var="pro">
                                                <tr>
                                                    ...
                                                    <td>${pro.catagories.catagoryId}</td>
                                                    <td>${pro.sales.saleId}</td>
                                                    <td>${pro.brands.brandId}</td>
                                                    <td><fmt:formatDate value="${pro.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${pro.isDisabled}</td>
                                                    <td><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminProductsController/initUpdate.htm?productId=${pro.productId}"/>
                                                         &nbsp;
                                                        <a class="glyphicon glyphicon-remove" title="Delete" href="${contextPath}/ShowyClothes/adminProductsController/delete.htm?productId=${pro.productId}"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                    <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminProductsController/initInsert.htm">Add Product</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
