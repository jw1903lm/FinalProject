                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="proUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Product Name:</td> 
                                                <td><f:input path="productName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product Price</td> 
                                                <td><f:input path="price" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product Description</td> 
                                                <td><f:input path="productDescription" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Best Seller</td> 
                                                <td><f:input path="bestSeller" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Category</td> 
                                                <td><f:input path="catagories.catagoryName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Sale</td> 
                                                <td><f:input path="sales.saleName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Brand</td> 
                                                <td><f:input path="brands.brandName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminProductsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
