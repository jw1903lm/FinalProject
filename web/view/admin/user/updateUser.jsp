                                ...
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="userUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Password</td> 
                                                <td><f:password style="width:350px"path="userPassword"/></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td> 
                                                <td><f:input style="width:350px" path="email"/></td>
                                            </tr>
                                            <tr>
                                                <td>Full Name</td> 
                                                <td><f:input style="width:350px" path="fullName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Phone</td> 
                                                <td><f:input style="width:350px" path="phone"/></td>
                                            </tr>
                                            <tr>
                                                <td>City ID</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>User Address</td> 
                                                <td><f:input style="width:350px" path="userAddress"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
