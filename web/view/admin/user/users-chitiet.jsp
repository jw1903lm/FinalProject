                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="userUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">User ID</td> 
                                                <td><f:input style="width:350px" path="userId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>User Name</td> 
                                                <td><f:input style="width:350px" path="userName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Password</td> 
                                                <td><f:input style="width:350px" path="userPassword" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td> 
                                                <td><f:input style="width:350px" path="email" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Full Name</td> 
                                                <td><f:input style="width:350px" path="fullName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Phone</td> 
                                                <td><f:input style="width:350px" path="phone" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>City</td>
                                                <td><f:input style="width:350px" path="cities.cityName" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>User Address</td> 
                                                <td><f:input style="width:350px" path="userAddress" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminUsersController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
