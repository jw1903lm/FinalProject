                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="cityUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">City ID</td> 
                                                <td><f:input path="cityId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>City Name</td> 
                                                <td><f:input path="cityName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Distance</td> 
                                                <td><f:input path="distance"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminCitiesController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
