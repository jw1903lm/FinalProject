                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Size Name" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listSize}" var="size">
                                                <tr>
                                                    ...
                                                    <td>${size.sizeName}</td>
                                                    <td>${size.stock}</td>
                                                    <td>${size.products.productName}</td>
                                                    <td><fmt:formatDate value="${size.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${size.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminSizesController/initUpdate.htm?sizeId=${size.sizeId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminSizesController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
