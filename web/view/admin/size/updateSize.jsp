                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Size</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="sizeUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Size ID</td> 
                                                <td><f:input path="sizeId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Size Name</td> 
                                                <td><f:input path="sizeName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Stock</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminSizesController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
