                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="banUpdate" enctype="multipart/form-data">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">Banner ID:</td> 
                                            ...
                                            <tr>
                                                ...
                                                <td><f:input path="bannerDescription"/></td>
                                            </tr>
                                            <tr>
                                                <td>Banner Image:</td> 
                                                <td><f:input type="file" path="bannerImage"/></td>
                                            </tr>
                                            <tr>
                                                <td>Size:</td> 
                                                <td>Big <f:radiobutton value="true" path="size"/>
                                                    Small <f:radiobutton value="false" path="size"/>   
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Category</td> 
                                                <td><f:select path="catagories.catagoryId">
                                                        <f:options items="${listCategory}" itemLabel="catagoryName" itemValue="catagoryId"/> 
                                                    </f:select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>True <f:radiobutton value="true" path="isDisabled"/>
                                                    False <f:radiobutton value="false" path="isDisabled"/>   
                                                </td>
                                            </tr>            
                                        </table>  
                                        <input type="submit" value="Update"/>  
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminBannersController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
