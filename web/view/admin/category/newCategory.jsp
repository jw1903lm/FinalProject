                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <f:form method="post" action="insert.htm" commandName="catInsert">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td>Category Name</td> 
                                                <td><f:input path="catagoryName"/></td>
                                            </tr>
                                            <tr>
                                                <td>Category Priority</td> 
                                                <td><f:input path="catagoryPriority"/></td>
                                            </tr>
                                            <tr>
                                                <td>Parent ID</td> 
                                            ...
                                            <tr>
                                                <td>Disabled</td> 
                                                <td>True <f:radiobutton value="true" path="isDisabled" id="disabled"/>
                                                    False <f:radiobutton value="false" path="isDisabled" id="disabled"/>   
                                                </td>
                                            </tr>            
                                        </table>  
                                        <input type="submit" value="Add new"/>  
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminCategoriesController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
