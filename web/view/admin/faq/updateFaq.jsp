                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="faqUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td width="150px">FAQ ID</td> 
                                                <td><f:input path="faqId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Question</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminFAQController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
