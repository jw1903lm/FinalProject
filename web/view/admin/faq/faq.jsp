                            ...
                            <div class="box">
                                <form id="doSearch" method="post"  action="doSearch.htm">
                                    <div class="box-header">
                                        <span style="margin-top: 10px" class="glyphicon glyphicon-search" onclick="document.getElementById('doSearch').submit();">&nbsp;</span><input style="border:none" placeholder="Search Question" name="search"/>
                                    </div>
                                </form>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listFaq}" var="faq">
                                                <tr>
                                                    ...
                                                    <td>${faq.question}</td>
                                                    <td>${faq.answer}</td>
                                                    <td><fmt:formatDate value="${faq.created}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                    <td>${faq.isDisabled}</td>
                                                    <td style="text-align: center"><a class="glyphicon glyphicon-pencil" title="Update" href="${contextPath}/ShowyClothes/adminFAQController/initUpdate.htm?faqId=${faq.faqId}"/>
                                                        &nbsp;
                                                        <a class="glyphicon glyphicon-plus" title="Add new" href="${contextPath}/ShowyClothes/adminFAQController/initInsert.htm"/></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
