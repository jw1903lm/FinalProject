                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Update Order Detail</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <f:form method="post" action="update.htm" commandName="orderDetailUpdate">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <tr>
                                                <td>Order</td> 
                                                <td><f:input path="orders.orderId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Product</td> 
                                            ...
                                            <tr>
                                                <td>Size</td> 
                                                <td><f:input path="sizes.sizeId" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td>Disabled</td> 
                                        ...
                                        <button><a style="text-decorations:none; color:inherit;" href="${contextPath}/ShowyClothes/adminOrderDetailsController/getAll.htm">Turn back</a></button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
